...
type SimpleStateCheckerResult<TState extends IHasSimpleStateCheckers<TState>> =
  Recordable<TState, boolean>;

declare interface SimpleStateCheckerContext<
  TState extends IHasSimpleStateCheckers<TState>
> {
  state: TState;
}

declare interface SimpleBatchStateCheckerContext<
  TState extends IHasSimpleStateCheckers<TState>
> {
  states: TState[];
}

declare interface IHasSimpleStateCheckers<
  TState extends IHasSimpleStateCheckers<TState>
> {
  stateCheckers: ISimpleStateChecker<TState>[];
}

declare interface ISimpleStateChecker<
  TState extends IHasSimpleStateCheckers<TState>
> {
...
declare interface ISimpleBatchStateChecker<
  TState extends IHasSimpleStateCheckers<TState>
