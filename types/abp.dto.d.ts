...
declare interface CreationAuditedEntityDto<TPrimaryKey>
...
declare interface AuditedEntityDto<TPrimaryKey>
  extends CreationAuditedEntityDto<TPrimaryKey> {
...
declare interface ExtensibleCreationAuditedEntityWithUserDto<
  TPrimaryKey,
  TUserDto
...
declare interface FullAuditedEntityDto<TPrimaryKey>
  extends AuditedEntityDto<TPrimaryKey> {
  isDeleted: boolean;
  deleterId?: string;
  deletionTime?: Date;
...
declare interface ExtensibleListResultDto<T>
...
declare interface ExtensiblePagedResultDto<T>
...
declare interface ExtensiblePagedResultRequestDto
  extends PagedResultRequestDto,
    ExtensibleObject {}
