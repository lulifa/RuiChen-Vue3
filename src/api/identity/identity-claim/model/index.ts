...
export interface CreateIdentityClaimType
  extends CreateOrUpdateIdentityClaimType {
  name: string;
  isStatic: boolean;
  valueType: ValueType;
}

export interface UpdateIdentityClaimType
  extends CreateOrUpdateIdentityClaimType {}
...
export interface IdentityClaimTypeListResult
  extends ListResultDto<IdentityClaimType> {}

export interface IdentityClaimTypePagedResult
  extends PagedResultDto<IdentityClaimType> {}
